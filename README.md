...
> Nota: El preview de GitHub no puede ejecutar animaciones, pero aquí puedes colocar imágenes o GIFs de ejemplo.

![Animación de letras y corazones](screenshots/preview.gif)  
*Ejemplo de la animación de letras subiendo con corazones y estrellas.*

![Interfaz del botón de inicio](screenshots/button.png)  
